function openerp_picking_widgets(instance){
    ...
    module.PickingEditorWidget = instance.web.Widget.extend({
        ...
        get_header_packaging_info: function(){
            return this.getParent().get_header_packaging_info();
        },
        ...
        renderElement: function(){
            ...
            this.$('.js_print_label').click(function(){
                self.getParent().print_labels($(this).data('id'));
            });
    ...
    module.PickingMainWidget = module.MobileWidget.extend({
        ...
        load: function(picking_id){
            ...
            return loaded_picking.then(function(){
                    ...
                    return new instance.web.Model("res.partner")
                        .query(['id','name','street','zip','city','phone','parent_id', 'country_id'])
        ...
        get_header_info: function(){
            if(this.picking){
                ...
                values.push({key:"Order #", value:this.picking.external_order_number, css:'font-size: 18px;font-weight: bold;'})
                values.push({key:"Date", value:this.picking.date,css:''})
                values.push({key:"ASN Date", value:this.picking.asn_date, css:''})
        ...
        get_header_packaging_info: function(){
            if(this.picking){
                var values = [];
                values.push({key:"Service", value:this.picking.shipping_rule, css:'font-size: 18px;font-weight: bold;'})
                values.push({key:"Product Qty", value:this.picking.product_quantity, css:''})
                values.push({key:"Packaging", value:this.picking.logistic_unit,css:'font-size: 18px;font-weight: bold;'})
                values.push({key:"Tracking", value:this.picking.tracking_number, css:''})
                values.push({key:"Gross weight (Kg)", value:this.picking.total_picking_weight, css:''})
                values.push({key:"Net weight (Kg)", value:this.picking.net_picking_weight, css:''})
        ...
        print_label: function(id){
            var self = this;
            return new instance.web.Model('stock.pack.operation').call('print_labels',[[id]])
               .then(function(action){
                    return self.do_action(action);
               });
                ...
                return new instance.web.Model("product.template")
                    ...
                    .then(function(product_tmpls) {
                        for(var i = 0; i < product_tmpls.length; i++){
                            ...
                            self.product_templates[product_template.id] = product_template.name[1];
                        }
        ...
        load: function(){
            ...
            return new instance.web.Model("stock.picking.type")
                ...
                .then(function(picking_types) {
                    ...
                    return new instance.web.Model("stock.picking")
                        .query(['id','name','external_order_number', 'shipping_rule', 'date','partner_id','state','origin','min_date'])
        ...
        load: function(product_id){
            ...
            if(product_id){
                ...
                .then(function(prod) {
                    ...
                    return new instance.web.Model("product.template")
                        .query(['id','qty_available','image_medium','categ_id'])
                    ...
                    return new instance.web.Model("stock.picking")
                        .query(['id','name', 'external_order_number', 'shipping_rule', 'date','partner_id','state','picking_type_id','product_qty'])
            ...
            return new instance.web.Model("stock.picking")
                ...
                .then(function(pickings) {
                    ...
                    return new instance.web.Model("stock.move")
                     ...
                     return new instance.web.Model("res.partner")
                        .query(['id','name','street','zip','city','phone', 'country_id'])
    ...
    module.IncomingProductWidget = module.PageWidget.extend({
        ...
        searchProducts: function(searchString){
            ...
            return new instance.web.Model("product.template")
                    ...
                    .then(function(product_tmpls) {
                        for(var i = 0; i < product_tmpls.length; i++){
                            var product_template = product_tmpls[i];
                            product_templates[product_template.id] = product_template.name[1];
                        }
                        return new instance.web.Model("stock.picking")
                            .query(['id'])
                            .filter([['state', 'in', ['assigned','partially_available']]])
                        ...
                        for(var i = 0; i < prods.length; i++){
                            ...
                            product.ean13 = product.ean13 ? product.ean13 : ""
                            product.label = product.name + "[" + product.default_code + "]";
        ...
        loadProduct: function(product_filter_argument){
            ...
            .then(function(prod) {
                ...
                return new instance.web.Model("product.template")
                    .query(['id','qty_available','virtual_available','image_medium','categ_id'])
...
//old sort method:  picks.sort(function(a, b) {if(a.partner_id[1] == b.partner_id[1]){return a.min_date.localeCompare(b.min_date);} return a.partner_id[1].localeCompare(b.partner_id[1]);})
        ...
        scan: function(product_filter_argument){ //scans a barcode, sends it to the server, then reload the ui
            ...
            if(product_filter_argument[0]=='ean13'){
                //for ean13 barcodes with 12 characters
